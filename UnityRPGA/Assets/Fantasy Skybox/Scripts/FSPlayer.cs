...
#region Component Segments
	...
	void OnGUI () {
		...
		GUI.Label(new Rect((Screen.width-150)/2, (Screen.height-25)/2, 150, 25), m_LightAndSkyList[m_CurrentSkyBox].m_Name, centeredStyle);		
		...
		GUI.Window(2, new Rect((Screen.width-220), Screen.height-85, 210, 80), HelpWindow, string.Format("{0:00}/{1:00}",m_CurrentSkyBox+1, m_LightAndSkyList.Length) + " (" + m_LightAndSkyList[m_CurrentSkyBox].m_Name +")");
...
#region Functions
	...
	{
		GUI.Label(new Rect(15, 25, 240, 20), "Fantasy Skybox 1.2.1");
